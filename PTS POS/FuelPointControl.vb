			...
			If _fuelPoint.OrderMode = OrderModes.Preset Then
				If _fuelPoint.ActiveNozzle Is Nothing Then
					If _pts.SelectedAuthorizationType = AuthorizeType.Volume Then
						'fuelPoint.Authorize(AuthorizeType.Volume, (int)(volumeUpDown.Value * 100), Convert.ToByte(nozzleUpDown.Value));
						Select Case GlobalVariables.VolumeDigits
							Case 2
								_fuelPoint.Authorize(AuthorizeType.Volume, CInt(Fix(volumeUpDown.Value * 100)), Convert.ToByte(nozzleUpDown.Value))
							Case 3
								_fuelPoint.Authorize(AuthorizeType.Volume, CInt(Fix(volumeUpDown.Value * 1000)), Convert.ToByte(nozzleUpDown.Value))
						End Select
					Else
						'fuelPoint.Authorize(AuthorizeType.Amount, (int)(paymentUpDown.Value * 100), Convert.ToByte(nozzleUpDown.Value));
						Select Case GlobalVariables.AmountDigits
							Case 0
								_fuelPoint.Authorize(AuthorizeType.Amount, CInt(Fix(paymentUpDown.Value * 1)), Convert.ToByte(nozzleUpDown.Value))
							Case 1
								_fuelPoint.Authorize(AuthorizeType.Amount, CInt(Fix(paymentUpDown.Value * 10)), Convert.ToByte(nozzleUpDown.Value))
							Case 2
								_fuelPoint.Authorize(AuthorizeType.Amount, CInt(Fix(paymentUpDown.Value * 100)), Convert.ToByte(nozzleUpDown.Value))
							Case 3
								_fuelPoint.Authorize(AuthorizeType.Amount, CInt(Fix(paymentUpDown.Value * 1000)), Convert.ToByte(nozzleUpDown.Value))
						End Select
					End If
				Else
					If _pts.SelectedAuthorizationType = AuthorizeType.Volume Then
						'fuelPoint.Authorize(AuthorizeType.Volume, (int)(volumeUpDown.Value * 100), 0);
						Select Case GlobalVariables.VolumeDigits
							Case 2
								_fuelPoint.Authorize(AuthorizeType.Volume, CInt(Fix(volumeUpDown.Value * 100)), 0)
							Case 3
								_fuelPoint.Authorize(AuthorizeType.Volume, CInt(Fix(volumeUpDown.Value * 1000)), 0)
						End Select
					Else
						'fuelPoint.Authorize(AuthorizeType.Amount, (int)(paymentUpDown.Value * 100), 0);
						Select Case GlobalVariables.AmountDigits
							Case 0
								_fuelPoint.Authorize(AuthorizeType.Amount, CInt(Fix(paymentUpDown.Value * 1)), 0)
							Case 1
								_fuelPoint.Authorize(AuthorizeType.Amount, CInt(Fix(paymentUpDown.Value * 10)), 0)
							Case 2
								_fuelPoint.Authorize(AuthorizeType.Amount, CInt(Fix(paymentUpDown.Value * 100)), 0)
							Case 3
								_fuelPoint.Authorize(AuthorizeType.Amount, CInt(Fix(paymentUpDown.Value * 1000)), 0)
						End Select
					End If
				End If
			Else

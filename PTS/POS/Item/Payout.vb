Public Class Payout
    ...
    Private Sub tbother_TextChanged(sender As Object, e As EventArgs) Handles tbother.TextChanged
        ...
        End Try
    End Sub
    Private Sub Payout_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    lbcash.Text = TiT.PTS.MainForm.txtuser.Text
    lbbatch.Text = cmd.getSpecificRecord("SELECT  0+COALESCE(Max(BatchNumber),0)  FROM Batch  ")
    End Sub
    ...
    Private Sub btsave_Click(sender As Object, e As EventArgs) Handles btsave.Click
        ...
        cmd.AddRecord("INSERT INTO DropPayout ( [StoreID] ,[Type] ,[BatchNumber]  ,[CashierID] ,[Amount] ,[Comment])values('" & storeid & "','1','" & lbbatch.Text & "','" & lbcash.Text & "','" & LBtotal.Text & "','" & txtcomment.Text & "')")
    ...
    crc.cr(TiT.PTS.MainForm.batchNumber, TiT.PTS.MainForm.ShiftNumber, TiT.PTS.MainForm.Cashierid)
    frmDropPayout.Close()
